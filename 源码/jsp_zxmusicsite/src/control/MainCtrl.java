	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("login"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				String sql1="";
				if (utype.equals("注册会员"))
				{
					sql1 = "select * from huiyuanzhuce where huiyuanhao='"+username+"' and mima='"+password+"' and issh='是'"; 
			...
			if(userlist1.size()==1)
			{
				if (utype.equals("注册会员"))
				{
					request.getSession(). setAttribute("username", userlist1.get(0).get("huiyuanhao"));  
				}
				else
				{
