...
<html>
 ...
 %>
  ...
  <form name="form2" action="delall.jsp">
	...
	new CommDAO().delete(request,"xinwentongzhi"); 
    String url = "xinwentongzhi_list.jsp?lb=��վ����"; 
    String sql =  "select * from xinwentongzhi where leibie='��վ����' ";
	...
	%>
        ...
        <td width="60" align="center"><a href="xinwentongzhi_updt.jsp?id=<%=map.get("id")%>&lb=<%=map.get("leibie")%>">�޸�</a> <a onClick="return confirm('ȷ��Ҫɾ��������¼��?')"  href="xinwentongzhi_list.jsp?scid=<%=map.get("id")%>&lb=<%=map.get("leibie")%>">ɾ��</a></td>
