        ...
        <td><table width="188" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                  ...
                  <tr>
                    <td class="menubg1" onMouseover="this.className='menubg2'" onMouseout="this.className='menubg1'"><a href="huiyuanzhuce_list.jsp" target="right">注册会员管理</a> </td>
                  </tr>
                  <tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="xinwentongzhi_add.jsp" target="right">网站公告添加</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="xinwentongzhi_list.jsp" target="right">网站公告查询</a></td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="yinyueleixing_add.jsp" target="right">音乐类型添加</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="yinyueleixing_list.jsp" target="right">音乐类型查询</a></td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="yinyueyuzhong_add.jsp" target="right">音乐语种添加</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="yinyueyuzhong_list.jsp" target="right">音乐语种查询</a></td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="xinwentongzhi_add2.jsp" target="right">音乐资讯添加</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="xinwentongzhi_list2.jsp" target="right">音乐资讯查询</a></td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
				  ...
				  <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="dx.jsp?lb=联系我们" target="right">联系我们</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="dx.jsp?lb=关于我们" target="right">关于我们</a></td>
                  </tr>
                   <tr>
                     <td height="5"></td>
                   </tr>
