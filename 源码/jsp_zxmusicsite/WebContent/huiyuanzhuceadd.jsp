...
function checkform()
{
	var huiyuanhaoobj = document.getElementById("huiyuanhao"); if(huiyuanhaoobj.value==""){document.getElementById("clabelhuiyuanhao").innerHTML="&nbsp;&nbsp;<font color=red>请输入会员号</font>";return false;}else{document.getElementById("clabelhuiyuanhao").innerHTML="  "; } 	var huiyuanhaoobj = document.getElementById("huiyuanhao");  
...
if(msg.indexOf('Y')>-1){
document.getElementById("clabelhuiyuanhao").innerHTML="&nbsp;&nbsp;<font color=red>会员号已存在</font>";  
return false;
